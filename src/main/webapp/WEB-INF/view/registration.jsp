...
<c:if test="${sessionScope.Login!=null}">
    <c:redirect url="/pages/guest/index"/>
</c:if>
<div id="q-app">
    <div>
    ...
    <div class="q-pa-md row justify-center">
        <div class="col-6">
            ...
            <div class="row justify-center items-center">
                <div class="col-auto">
            <q-form action="makeRegistration" method="post">
                <q-input
                        filled
                        debounce="300"
                        type="text"
                ...
                <div class="col-auto">
                    <q-btn square label="<fmt:localeValue key="masterRegistration"/>" color="yellow-14" @click="masterRegistration()" icon="login"></q-btn>
                </div>
            </div>
        </div>
    </div>
